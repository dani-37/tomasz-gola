            ...
            <section className="mx-auto max-w-screen-xl px-[5%] md:px-20 lg:px-40">
                <Stack 
                    ...
                    <Box sx={{ width: '100%',  borderRadius: '8px'}}>
                        <CardMedia
                        component="img"
                        sx = {{width:'100%', maxHeight:{sm:550, xs:300}, borderRadius:'4px', pb:{sm:'4rem', xs:0}}}
                        image= {imagePath} 
                        alt={title}
                        />
                    </Box>

                    <Box sx={{ width: '100%', pr:{xs:'10%', sm:0}}}>
                        <header className='font-aptos text-4xl pb-4 sm:pb-10'>
                            {title}
                        </header>

                        <p className='font-aptos font-thin text-sm pb-16'>
                            {description}
                        </p>
                ...
                <Box className="mx-auto max-w-screen-xl px-[5%] md:px-20 lg:px-40 border-b-[2px] pt-4"/>
            </section>
        </div>
    );
}
